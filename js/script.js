...
function Danylo(sldrId) {
	...
	this.options = Danylo.defaults;
	Danylo.initialize(this)
};
...
Danylo.prototype.elemPrev = function(num) {
	num = num || 1;
...
Danylo.prototype.elemNext = function(num) {
	num = num || 1;
...
Danylo.prototype.dotOn = function(num) {
	this.indicatorDotsAll[num].style.cssText = 'background-color:#BBB; cursor:pointer;'
};

Danylo.prototype.dotOff = function(num) {
	this.indicatorDotsAll[num].style.cssText = 'background-color:#556; cursor:default;'
};

Danylo.initialize = function(that) {
